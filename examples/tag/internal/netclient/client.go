// Package netclient is the client half of Tag's SGSP protocol, independent of
...
func (c *Client) Send(ctx context.Context, input protocol.Input) error {
	return sgsp.Emit(ctx, c.Connection.Session(), protocol.Inputs, input, protocol.InputOptions)
}
